...
#define MILLISECONDS_PREHEAT_TIME 3000
...
#define Z_STEPPER_AUTO_ALIGN
  ...
  #define Z_STEPPER_ALIGN_XY { {  25, 105 }, { 225, 105 } }
 ...
 */
  ...
  // Note: this values cannot be calibrated and have to be set manually
    ...
    #define PTC_PARK_POS   { 245, 105, 100 }

    // Probe position to probe and wait for probe to reach target temperature
    #define PTC_PROBE_POS  { 125, 105 }
    ...
    #define PTC_SAMPLE_COUNT   6

    // Bed temperature calibration builds a similar table.

    #define BTC_SAMPLE_START  70  // (°C)
    #define BTC_SAMPLE_RES     5  // (°C)
    #define BTC_SAMPLE_COUNT  9
